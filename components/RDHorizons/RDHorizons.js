...
export default function RDHorizons() {
  ...
  const clusters = [
    ...
    {
      id: 1,
      name: 'Autonomous Systems & Logistics (LEI Powered)',
      shortName: 'Autonomous & Robotics',
      icon: '🛸',
      tagline: 'Sub-20µs Embedded Sensor Fusion for Edge & Aerial Platforms',
      flagship: 'LEI (Librae Edge Intelligence)',
      domains: [
        {
          id: 6,
    ...
    {
      id: 2,
      name: 'National Security & Cyber-Immunity (LIA Powered)',
      shortName: 'Cyber-Immunity & Defense',
      icon: '🛡️',
      tagline: 'Deterministic Zero-Trust Immune Infrastructure for High-Consequence Assets',
      flagship: 'LIA (Librae Immune Agency)',
      domains: [
        {
          id: 11,
